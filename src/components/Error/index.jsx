...
const Error = ({ text, title, status }) => {
    ...
    return (
        <section
            className="flex flex-col justify-center p-11 max-md:p-3 w-[710px] bg-[#929292]/5 max-xl:w-full gap-11 rounded-3xl border border-solid border-white border-opacity-10">
