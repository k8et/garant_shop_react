...
const FindDelivery = ({title, text, client, response}) => {
    ...
    return (
        <div className={"absolute z-[99] bg-[#1C1C1C] left-0  top-0 h-full w-full flex items-center justify-center"}>
            {client ?
                <section
                    className="flex flex-col justify-center max-md:p-3  p-11 w-[614px] max-h-[400px] bg-[#929292]/5 max-xl:w-full gap-11 rounded-3xl border border-solid border-white border-opacity-10 ">
                    ...
                    <div
                        className="flex gap-5 justify-between p-2 text-2xl font-medium leading-8 whitespace-nowrap rounded-2xl border border-solid border-white border-opacity-10 max-w-[498px] m">
