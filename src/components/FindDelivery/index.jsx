...
const FindDelivery = ({title, text, client, response, simple, className}) => {
    ...
    return (
        <div className={`absolute z-[99] bg-[#1C1C1C] left-0 p-4 ${className} top-0 h-full w-full flex items-center justify-center`}>
            {client ?
                <section
