    ...
    return (
        <div className="w-full h-[80px] z-[120] flex items-center justify-center">
            <div className="flex items-center relative justify-center gap-2 ">
                <a target={"_blank"} href="https://t.me/garantshopinfo" className={"flex gap-2"} rel="noreferrer">
                    <Icon className="" name="telegram" height={40} width={40}/>
                    <Button className="!bg-none border border-[#745EEC] !h-[40px]">{t('footer.ask_question')}</Button>
                </a>
                <button
                    onClick={toggleDropdown}
                    className="w-[173px] text-xl h-[53px] max-md:hidden flex items-center justify-center gap-2"
                >
                ...
                {isDropdownOpen && (
                    <div
                        className="absolute bottom-[60px] text-xl right-0 w-[173px] bg-[#202020]  flex flex-col gap-2 border border-white/10 rounded-xl p-2 shadow-lg">
                        <div
